...
const data = {
  ...
  profile: {
    name: "Johan Ricardo N.",
    rol: "Frontend UI / DEV",
    desc: "Passionate about crafting captivating web experiences",
    urlAvatar: "https://res.cloudinary.com/dcplixyte/image/upload/v1698338685/porfolio/1517282589750_jodhdz.jpg",
    socials: [
      {
        id: uuidv4(),
        name: "Github",
        url: "https://github.com/JohanRicardoN",
        icon: "IoLogoGithub"
      },
      {
        id: uuidv4(),
